...
sbit MOTOR_2_DRIVER_IN1  = P2^4;
sbit MOTOR_2_DRIVER_IN2  = P2^5;
sbit MOTOR_2_DRIVER_EN1  = P2^3;

/* -------- LED Interface --------- */
sbit ERROR_LED                = P1^3;
sbit MOTOR_1_OFF_LED          = P1^2;
sbit MOTOR_1_CLOCKWISE_LED    = P1^1;

sbit MOTOR_2_OFF_LED          = P2^7;
sbit MOTOR_2_CLOCKWISE_LED    = P2^6;

/* -------- SW Interface --------- */
sbit ERR_RESET_SW             = P3^4;
